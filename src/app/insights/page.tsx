        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[1px] bg-[var(--line)]">
            {[
              ...
              >
                <div className="text-3xl font-display font-light text-chrono-text mb-2">{ch.year}</div>
                <div className="text-sm font-display font-light text-chrono-text mb-3">{ch.title}</div>
                <p className="text-xs font-body font-light text-chrono-muted leading-relaxed mb-4">{ch.desc}</p>
